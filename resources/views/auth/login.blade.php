...
<body>
    ...
    <div class="absolute flex items-center justify-center h-screen w-screen backdrop-blur-sm">
        <div class="flex flex-col justify-items-center">
            <form class="max-w-screen-sm mx-auto bg-gray-100 p-8 px-16 rounded-lg shadow-md shadow-gray-50 bg-[url('../assets/bear.png)]" action="" onSubmit={Auth}>
                ...
                <div class="flex flex-col text-gray-400 py-2">
                    ...
                    <input class="rounded-lg text-gray-500 bg-gray-300 mt-2 p-1 focus:border-x-green-400 focus:bg-gray-400 focus:outline-none " type="text" placeholder="username" value="ssss" name="" id="" required />
                </div>
                <div class="flex flex-col text-gray-400 py-2 ">
                    <label class="text-gray-500 font-semibold text-left" htmlFor="">
                        Password
                    </label>
                    <input class="rounded-lg text-gray-500 bg-gray-300 mt-2 p-1 focus:border-x-green-400 focus:bg-gray-400 focus:outline-none " type="password" placeholder="password" value="ssss" name="" id="" required />
                </div>
